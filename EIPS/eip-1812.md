...
[ERC-735](./eip-735.md) and [ERC-780](./eip-780.md) provide methods of making claims that live on chain. This is useful for some particular use cases, where some claim about an address must be verified on chain. 
...
[ERC-735](./eip-735.md) and [ERC-780](./eip-780.md) provide on-chain storage and lookups of Verifiable Claims.
