...
- [EIP-92](./eip-92.md) proposed the transaction gas limit to be limited at `2**63 - 1` and had a lengthy discussion about other limits.
- [EIP-106](./eip-106.md) proposed the block gas limit to be limited at `2**63 - 1`.
